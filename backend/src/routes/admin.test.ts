...
describe("GET /pipeline-health", () => {
  const mockHealth = {
    ...
    windowEnd: "2026-05-09T00:00:00.000Z",
    exchanges: {
      binanceus: { lastDataAt: "2026-05-09T00:00:00Z", streamHealth: "healthy", stalenessSec: 30 },
      kraken: { lastDataAt: "2026-05-08T23:55:00Z", streamHealth: "stale", stalenessSec: 360 },
      coinbase: { lastDataAt: null, streamHealth: "down", stalenessSec: null },
    },
    quorum: {
      successRate: 0.95,
