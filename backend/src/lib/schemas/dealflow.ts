...
export const DealPost = z.object({
  dealId: z.string(),
  authorId: z.string(),
  title: z.string(),
...
export const DealsListResponse = z.object({
...
export const DealDetailResponse = z.object({
  success: z.literal(true),
  data: z.object({ deal: DealPost.nullable() }),
}).openapi("DealDetailResponse");

export const DealProfileResponse = z.object({
  success: z.literal(true),
