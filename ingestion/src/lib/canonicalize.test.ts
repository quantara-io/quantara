...
describe("canonicalizeCandle", () => {
  ...
  it("uses median for open, high, low, volume fields as well", () => {
    const candles = {
      binanceus: makeCandle({ exchange: "binanceus", open: 29900, high: 30600, low: 29700, volume: 90 }),
      coinbase:  makeCandle({ exchange: "coinbase",  open: 30000, high: 30500, low: 29800, volume: 100 }),
